...
I'm a Computer Science undergraduate specializing in Artificial Intelligence, with a strong interest in building practical AI and machine learning systems.

I enjoy working across the complete ML lifecycle — from **data preparation and feature engineering to model training, evaluation, integration, and deployment**. My interests include **computer vision, deep learning, Generative AI, RAG systems, and applied machine learning**.

I'm particularly interested in turning research concepts into **useful, reliable, and production-oriented AI applications**.
...
<i>Learning today. Building tomorrow. Engineering intelligent systems.</i>
